...
public class RandomGenerator {
    ...
    public RandomGenerator(Integer minCollectionSize, Integer maxCollectionSize) {
        this.minCollectionSize = minCollectionSize;
        this.maxCollectionSize = maxCollectionSize;
    }

    public RandomGenerator(Integer stringSize) {
        this.stringSize = stringSize;
    }

    public RandomGenerator(Integer minCollectionSize, Integer maxCollectionSize, Integer stringSize) {
        this.minCollectionSize = minCollectionSize;
        this.maxCollectionSize = maxCollectionSize;
        this.stringSize = stringSize;
    }
